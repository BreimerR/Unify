...
class KeywordStatic(private val keyword: String? = null) : IdentifierStatic(value = keyword ?: "") {
    ...
    private var keywords: String = "(package|protected|private|public|final|func|data|infix|prefix|act|class|abstract|closed|trait|public|static|void|null|when|for|if|elif|aka|else|switch|while|new|return|throw|do|TODO|todo|enum|var|val|const|impl|throws|returns|break|default|override)"
